function About() {
  return (
    <div className="about ml-80 mt-16">
      ...
      with a focus on game development and software engineering. <br />Committed to exceptional outcomes through coding expertise. <br />My favourite element is Nickel </div>
